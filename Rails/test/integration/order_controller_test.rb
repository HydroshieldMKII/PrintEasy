...
class OrderControllerTest < ActionDispatch::IntegrationTest
  ...
  def testOrder(tested_order)
    ...
    assert_equal offers(:one).printer_user.acquired_date.strftime("%a, %d %b %Y"), Date.parse(tested_order["offer"]["printer_user"]["acquired_date"]).strftime("%a, %d %b %Y")
    ...
    assert_equal offers(:one).request.target_date.strftime("%a, %d %b %Y"), Date.parse(tested_order["offer"]["request"]["target_date"]).strftime("%a, %d %b %Y")
