...
class AuthControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should sign up' do
    assert_difference('User.count', 1) do
      post user_registration_path,
           params: { user: { username: 'test', password: 'password', password_confirmation: 'password',
  ...
  test 'should not sign up -> no username' do
    assert_difference('User.count', 0) do
      post user_registration_path,
           params: { user: { password: 'password', password_confirmation: 'password', country_id: countries(:one).id } }
    end
  ...
  test 'should not sign up -> no password' do
    assert_difference('User.count', 0) do
      post user_registration_path,
           params: { user: { username: 'test', password_confirmation: 'password', country_id: countries(:one).id } }
    end
  ...
  test 'should not sign up -> no password confirmation' do
    assert_difference('User.count', 0) do
      post user_registration_path,
           params: { user: { username: 'test', password: 'password', country_id: countries(:one).id } }
    end
  ...
  test 'should not sign up -> password too short' do
    assert_difference('User.count', 0) do
      post user_registration_path,
           params: { user: { username: 'test', password: 'pass', password_confirmation: 'pass',
                             country_id: countries(:one).id } }
    end
  ...
  test 'should not sign up -> password and password confirmation do not match' do
    assert_difference('User.count', 0) do
      post user_registration_path,
           params: { user: { username: 'test', password: 'password', password_confirmation: 'password1' } }
    end
  ...
  test 'should not sign up -> username already taken' do
    assert_difference('User.count', 0) do
      post user_registration_path,
           params: { user: { username: users(:one).username, password: 'password', password_confirmation: 'password' } }
    end
