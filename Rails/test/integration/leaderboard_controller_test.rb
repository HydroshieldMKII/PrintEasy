...
class LeaderboardControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should get index sort by submissions_participation asc' do
    ...
    assert_equal 3, @parsed_response['leaderboard'].count
    assert @parsed_response['leaderboard'][0]['submissions_participation'].to_f <=
           @parsed_response['leaderboard'][1]['submissions_participation'].to_f

    assert @parsed_response['leaderboard'][1]['submissions_participation'].to_f <=
           @parsed_response['leaderboard'][2]['submissions_participation'].to_f
  end
  ...
  test 'should get index sort by winrate asc' do
    ...
    assert_equal 3, @parsed_response['leaderboard'].count
    assert @parsed_response['leaderboard'][0]['winrate'].to_f <=
           @parsed_response['leaderboard'][1]['winrate'].to_f

    assert @parsed_response['leaderboard'][1]['winrate'].to_f <=
           @parsed_response['leaderboard'][2]['winrate'].to_f
  end
  ...
  test 'should get index sort by wins asc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'wins', direction: 'asc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by wins desc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'wins', direction: 'desc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by submissions_participation asc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'submission_rate', direction: 'asc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by submissions_participation desc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'submission_rate', direction: 'desc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by participations asc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'participations', direction: 'asc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by participations desc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'participations', direction: 'desc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by total_likes asc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'total_likes', direction: 'asc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by total_likes desc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'total_likes', direction: 'desc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by winrate asc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'winrate', direction: 'asc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
  ...
  test 'should get index sort by winrate desc with start_date and end_date' do
    assert_difference('User.count', 0) do
      get api_leaderboard_index_url,
          params: { category: 'winrate', direction: 'desc', start_date: '2024-01-01', end_date: Date.today.to_s }
    end
