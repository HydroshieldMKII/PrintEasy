...
class ReviewControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create review from Cancelled" do
    ...
    assert_difference('Review.count', 1) do
      post api_review_index_path, params: { review: { order_id: 7, rating: 3, title: "Review 1", description: "This is the first review", user_id: 2 } }, as: :json
    end
  ...
  test "should create review from Arrived" do
    sign_in users(:one)
    assert_difference('Review.count', 1) do
      post api_review_index_path, params: { review: { order_id: 5, rating: 3, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> Accepted" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 1, rating: 3, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> Printing" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 2, rating: 3, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> Printed" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 3, rating: 3, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> Shipped" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 4, rating: 3, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> not logged in" do
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 7, rating: 3, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> invalid order_id" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 999, rating: 3, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> invalid rating too much" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 7, rating: 6, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> invalid rating not enough" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 7, rating: -1, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> invalid title not enough" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 7, rating: 3, title: "R", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> invalid title too much" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 7, rating: 3, title: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", description: "This is the first review" } }, as: :json
    end
  ...
  test "should not create review -> invalid description not enough" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 7, rating: 3, title: "Review 1", description: "This" } }, as: :json
    end
  ...
  test "should not create review -> invalid description too much" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 7, rating: 3, title: "Review 1", description: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" } }, as: :json
    end
  ...
  test "should not create review -> already has a review" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      post api_review_index_path, params: { review: { order_id: 6, rating: 3, title: "Review 1", description: "This is the first review" } }, as: :json
    end
  ...
  test "should update review (also check that you can't change user or order)" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      patch api_review_url(1), params: { review: { rating: 2, title: "Review 2", description: "This is the second review", order_id: 5, user_id: 2 } }, as: :json
    end
  ...
  test "should not update review -> not logged in" do
    assert_difference('Review.count', 0) do
      patch api_review_url(1), params: { review: { rating: 2, title: "Review 2", description: "This is the second review" } }, as: :json
    end
  ...
  test "should not update review -> does not exist" do
    sign_in users(:one)
    assert_difference('Review.count', 0) do
      patch api_review_url(999), params: { review: { rating: 2, title: "Review 2", description: "This is the second review" } }, as: :json
    end
    ...
    assert_equal ["Couldn't find Review with 'id'=999 [WHERE `reviews`.`user_id` = ?]"], @parsed_response["errors"]["base"]
  end
  ...
  test "should not update review -> not owner" do
    ...
    assert_equal ["Couldn't find Review with 'id'=1 [WHERE `reviews`.`user_id` = ?]"], @parsed_response["errors"]["base"]
  end
