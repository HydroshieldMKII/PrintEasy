...
ActiveRecord::Schema[8.0].define(version: 20_250_306_021_659) do
  ...
  create_table 'likes', charset: 'utf8mb4', collation: 'utf8mb4_general_ci', force: :cascade do |t|
    ...
    t.index %w[user_id submission_id], name: 'index_likes_on_user_id_and_submission_id', unique: true
  ...
  create_table 'offers', charset: 'utf8mb4', collation: 'utf8mb4_general_ci', force: :cascade do |t|
    ...
    t.index %w[request_id printer_user_id color_id filament_id print_quality],
            name: 'idx_on_request_id_printer_user_id_color_id_filament_0fd26481dc', unique: true
  ...
  create_table 'preset_requests', charset: 'utf8mb4', collation: 'utf8mb4_general_ci', force: :cascade do |t|
    ...
    t.index %w[request_id color_id filament_id printer_id print_quality], name: 'index_preset_requests_uniqueness',
                                                                          unique: true
  ...
  create_table 'presets', charset: 'utf8mb4', collation: 'utf8mb4_general_ci', force: :cascade do |t|
    ...
    t.index %w[user_id filament_id color_id print_quality],
            name: 'idx_on_user_id_filament_id_color_id_print_quality_c373c36abc', unique: true
  ...
  create_table 'status', primary_key: 'name', id: :string, charset: 'utf8mb4', collation: 'utf8mb4_general_ci',
                         force: :cascade do |t|
  end
