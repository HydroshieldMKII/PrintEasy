...
ActiveRecord::Schema[8.0].define(version: 2025_03_06_171615) do
  ...
  create_table "offers", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.index ["request_id", "printer_user_id", "color_id", "filament_id", "print_quality"], name: "idx_on_request_id_printer_user_id_color_id_filament_0fd26481dc", unique: true
