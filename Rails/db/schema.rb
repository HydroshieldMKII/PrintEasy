...
ActiveRecord::Schema[8.0].define(version: 20_250_226_163_921) do
  ...
  create_table 'preset_requests', charset: 'utf8mb4', collation: 'utf8mb4_general_ci', force: :cascade do |t|
    ...
    t.index %w[request_id color_id filament_id printer_id print_quality],
            name: 'index_preset_requests_uniqueness', unique: true
